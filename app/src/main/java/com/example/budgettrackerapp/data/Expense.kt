...
data class Expense(
    ...
    val date: String = "",            // Date/due date of the expense (e.g., "2025-05-02")
    ...
    val notificationEnabled: Boolean = false, // Whether to send notifications for this expense
    val notificationDaysBefore: Int = 3 // How many days before due date to notify
) {
    // No-argument constructor required by Firebase
    constructor() : this("", 0.0, "", false, "", "", "", "", "", null, "", false, 3)
}
